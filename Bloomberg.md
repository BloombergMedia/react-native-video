...
This document describes all Bloomberg-specific modifications made to the [react-native-video](https://github.com/TheWidlarzGroup/react-native-video) library. This fork is based on version **6.18.0** and includes custom features and patches required for Bloomberg's video streaming applications.
...
**Base Version**: react-native-video 6.18.0
**Branch**: `clopez32-react-native-video-6.18-annotate`
...
**Primary Contributor**: maciej.budzinski.93@gmail.com
**Commit**: 221aba3e
...
**File**: `ios/Video/RCTVideo.swift:1268-1280`
...
**File**: `ios/Video/RCTVideo.swift:1040-1046`
...
**File**: `android/src/main/java/com/brentvatne/exoplayer/ReactExoplayerView.java:418-423`
...
**File**: `android/src/main/java/com/brentvatne/exoplayer/ExoPlayerView.kt:217-219`
...
**Files**:
- `android/src/main/java/com/brentvatne/exoplayer/ReactExoplayerView.java:1621, 1627`
- `android/src/main/java/com/brentvatne/react/VideoManagerModule.kt:21-31`

---

## Contributors

- **maciej.budzinski.93@gmail.com** - Primary DAI implementation, time conversion enhancements, legacy patches
- **krasnobaev@gmail.com** - Android live badge fix
...
1. `android/src/main/java/com/brentvatne/exoplayer/ReactExoplayerView.java` - ~230 lines of Bloomberg changes
...
- `docs/pages/component/ads.md` - DAI documentation (+157 lines)
- `docs/pages/component/props.mdx` - DAI props documentation (+57 lines)
- `examples/expo-dai/` - Complete DAI example application
