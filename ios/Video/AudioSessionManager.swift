...
class AudioSessionManager {
    ...
    // BLOOMBERG: Allow disabling audio session management
    private var isAudioSessionManagementForcedDisabled = false

    private var isAudioSessionManagementDisabled: Bool {
        // BLOOMBERG BEGIN
        // Purpose: Don't take audio control from other apps when just opening app
    ...
    func updateAudioSessionConfiguration() {
        ...
        // BLOOMBERG BEGIN
        // Purpose: Prevent taking audio control from other apps when just opening app
    ...
    private func configureAudioSession() {
        ...
        // BLOOMBERG BEGIN
        // Purpose: Only take exclusive audio when actually playing with notification controls
